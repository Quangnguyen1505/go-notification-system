...
func main() {
	...
	// OpenAPI (generated by `make protogen`) + Swagger UI
	mux.HandleFunc("/swagger/doc.json", func(w http.ResponseWriter, r *http.Request) {
		// Path is relative to the repo root (expected when running `go run ./cmd/proxy` from root).
		http.ServeFile(w, r, "third_party/OpenAPI/notification.swagger.json")
	})
	// Swagger UI is served at /swagger/ and will load JSON from /swagger/doc.json

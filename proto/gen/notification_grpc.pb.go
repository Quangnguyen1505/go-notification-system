...
const (
	NotificationService_CreateNotification_FullMethodName = "/go.notification.system.proto.notificationapi.NotificationService/CreateNotification"
	NotificationService_GetNotification_FullMethodName    = "/go.notification.system.proto.notificationapi.NotificationService/GetNotification"
	NotificationService_BatchNotification_FullMethodName  = "/go.notification.system.proto.notificationapi.NotificationService/BatchNotification"
)
...
func (c *notificationServiceClient) BatchNotification(ctx context.Context, in *BatchNotificationRequest, opts ...grpc.CallOption) (*BatchNotificationResponse, error) {
	...
	err := c.cc.Invoke(ctx, NotificationService_BatchNotification_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedNotificationServiceServer) BatchNotification(context.Context, *BatchNotificationRequest) (*BatchNotificationResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method BatchNotification not implemented")
}
...
func _NotificationService_BatchNotification_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: NotificationService_BatchNotification_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
